    	...
    	document.getElementById('locations').innerHTML=
    										...
    										+"<label for='location'>Enter Location Suggestions</label>"
         									+"<input type='text' name='location[]' class='form-control'>"
           									+"</div>"
           									+"<input type='button' id='addButton' class='btn btn-secondary'value='Add Suggestion' onClick='addSuggestion(locations);'>"
					 						+"<input type='button' class='btn btn-secondary'value='Remove Poll' onClick='togglePoll(locations);'>";
    	}else{
    		...
    		document.getElementById('locations').innerHTML=
    										"<label for='location'>Enter Location</label>"
         									+"<input type='text' name='location[]' class='form-control'>"
              								+"<input type='button' class='btn btn-secondary'value='Open to suggestions' onClick='togglePoll(locations);'>";
    	}
    	next_ID++;
